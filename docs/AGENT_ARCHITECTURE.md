...
- 有安全触发观察点、组合验证层、组合主题解释层和跨宫跨限运关系解释层，能把多层运限和四化重叠宫位列为待验证主题，筛出证据层数达标的合参主题，把已验证宫位转成阶段合参领域，并整理当前大限、流年、流月之间的同宫或分宫关系，但不会输出事件断语。
...
- 大限四化、流年骨架、流年四化、流月骨架、组合验证底座、组合主题解释和跨宫跨限运关系解释已接入，但细分组合规则和文献支撑仍然很少。
- 宫位、星曜、四化、运限之间的专题化解释仍然需要扩充。
