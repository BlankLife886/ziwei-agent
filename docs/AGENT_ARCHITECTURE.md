...
- 有本地参考目录和解释目录；性格画像的命宫星曜解释目录已覆盖十四主星和常见辅煞，四化类型解释已覆盖化禄、化权、化科、化忌，四化彼此合参已覆盖禄权、禄科、禄忌、权科、权忌、科忌，具体星曜被四化标记的角色边界已覆盖紫微、天机、太阳、武曲、天同、廉贞、太阴、贪狼、巨门、天梁、破军、文昌、文曲、左辅、右弼，星曜四化同宫合参基础边界已覆盖化禄、化权、化科、化忌，四化落宫解释已覆盖十二宫，命宫三方四正、生年四化和当前阶段章节可按结构化证据引用受控解释条目。
