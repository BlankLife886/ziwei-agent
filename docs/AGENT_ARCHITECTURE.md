...
- 事业专题：官禄宫三方四正，保守描述职责承担、主体基础、资源承接和合作牵动；当生年四化落入官禄宫时，专题章节会追加四化合参边界，但仍不推职位或阶段结果。
- 财富专题：财帛宫三方四正，保守描述资源经营、主体基础、事业承接和内在取舍；当生年四化落入财帛宫时，专题章节会追加四化合参边界，但仍不推金额或资源结果。
- 婚姻专题：夫妻宫三方四正，保守描述关系互动、外部相处、现实承担和内在感受；当生年四化落入夫妻宫时，专题章节会追加四化合参边界，但仍不推分合或婚恋结果。
...
- 有本地参考目录和解释目录；性格画像的命宫星曜解释目录已覆盖十四主星和常见辅煞，四化类型解释已覆盖化禄、化权、化科、化忌，四化彼此合参已覆盖禄权、禄科、禄忌、权科、权忌、科忌，具体星曜被四化标记的角色边界已覆盖紫微、天机、太阳、武曲、天同、廉贞、太阴、贪狼、巨门、天梁、破军、文昌、文曲、左辅、右弼，星曜四化同宫合参基础边界已覆盖化禄、化权、化科、化忌，四化落宫解释已覆盖十二宫，婚姻、财富、事业专题已能在本宫被生年四化命中时引用专题合参边界，命宫三方四正、生年四化、专题章节和当前阶段章节可按结构化证据引用受控解释条目。
