...
- 阶段运势：在提供 `analysis_date` 后定位当前大限，合看大限四化、流年骨架、流年四化和流月骨架，并形成安全触发观察点、组合验证主题、组合主题解释和当前阶段底稿。
...
- 有安全触发观察点、组合验证层和组合主题解释层，能把多层运限和四化重叠宫位列为待验证主题，筛出证据层数达标的合参主题，并把已验证宫位转成阶段合参领域，但不会输出事件断语。
...
- 大限四化、流年骨架、流年四化、流月骨架、组合验证底座和组合主题解释已接入，但深层跨宫、跨限运解释仍然很少。
