...
3. 更细的宫位、星曜、四化合参和运限组合解释；当前化禄、化权、化科、化忌、四化彼此合参、具体星曜被四化标记的角色边界、星曜四化同宫合参基础边界、十二宫四化落宫，以及婚姻、财富、事业专题本宫见生年四化、当前大限四化或流年四化的合参边界已接入受控结构解释，但精细到星曜、宫位、四化、主题的深层组合规则和文献支撑仍需扩充，且仍不输出财富、升迁、名声、婚姻、健康或灾祸结果断语。
4. 用户会话、历史咨询和长期记忆。
