...
当前阶段实现了出生资料采集、历法转换、命宫/身宫计算、五行局计算、十四主星基础落宫，左辅、右弼、天刑、天姚、天月、天巫等月系辅星，三台、八座等日系辅星，禄存、擎羊、陀罗、天魁、天钺、天官、天福等年干星曜，以及火星、铃星等基础煞曜。后续再逐步加入更多辅星煞曜、资料检索、命理分析和报告生成。
...
- `src/yearStemStarCalculator.js`: 根据出生年干计算禄存、擎羊、陀罗、天魁、天钺、天官、天福等星曜。
